...
int main(int argc, char* argv[]) {
	...
	auto _ = bserv::server{ config, {
		...
		bserv::make_path("/users/<int>", &view_users,
			...
			bserv::placeholders::response,
			bserv::placeholders::_1),
		bserv::make_path("/menu", &view_list,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			std::string{"1"}),
		bserv::make_path("/ordered", &view_ordered,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			std::string{"1"}),
		bserv::make_path("/ordered/<int>", &view_ordered,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::_1),
		bserv::make_path("/todolist", &view_todolist,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			std::string{"1"}),
		bserv::make_path("/todolist/<int>", &view_todolist,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::_1),
		bserv::make_path("/rec", &view_rec,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			std::string{"1"}),
		bserv::make_path("/rec/<int>", &view_rec,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::_1),
		bserv::make_path("/menu/<int>", &view_list,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::_1),
		bserv::make_path("/menu/spiciness", &view_spiciness,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			std::string{"1"}),
		bserv::make_path("/menu/search", &view_search,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
		...
		bserv::make_path("/more", &view_more,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session),
		bserv::make_path("/menu/cuisine", &view_cuisine,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
		...
		bserv::make_path("/form_add_user", &form_add_user,
			...
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session),
		bserv::make_path("/form_add_menu", &form_add_menu,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session),
		bserv::make_path("/form_add_cuisine", &form_add_cuisine,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
		...
		bserv::make_path("/delete_user", &delete_user,
			...
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session),
		bserv::make_path("/dmenu", &delete_menu,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session),
		bserv::make_path("/order", &orderin,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
		...
		bserv::make_path("/clear", &clear,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session),
		bserv::make_path("/dlt", &dlt,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
		...
		bserv::make_path("/tdset", &todo_set_favor,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
		...
		bserv::make_path("/tdplay", &todo_play,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
		...
		bserv::make_path("/tdclear", &todo_clear,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session),
		bserv::make_path("/tddlt", &todo_dlt,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
